...
from io.preprocessing import load_input_and_labels, shuffle_X_Y, to_data_set
...
X, Y = load_input_and_labels(many_to_many=MANY_TO_MANY,
...
tuner.search(
    ...
    workers=3,
    callbacks=[
        TensorBoard(log_dir="../../logs/tuning/"+project_name),
        EarlyStopping(
